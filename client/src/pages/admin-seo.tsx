                          ...
                          {article.slug && (
                            <div className="mb-3">
                              <p className="text-xs text-muted-foreground">
                                URL: <a href={`/column/${article.slug}`} target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">/column/{article.slug}</a>
                              </p>
                            </div>
                          )}
                          {article.faq && (
